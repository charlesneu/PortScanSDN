...
Call it with sudo mn --custom nstopo.py --topo nstopo --controller=remote,ip=127.0.0.1,port=6633 --switch ovs,protocols=OpenFlow13
"""

from mininet.topo import Topo

class NsTopo( Topo ):
    "NetSec testing topology."
